...
import { C as executeRewriteInput, O as rootRouteId, S as resolveManifestAssetLink, T as isResolvedRedirect, a as RouterProvider, j as invariant, k as isNotFound, t as renderRouterToStream, w as isRedirect } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DHXiDCwC.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Ck9BFpP3.mjs"),
		import("./start-D70tGx_X.mjs"),
