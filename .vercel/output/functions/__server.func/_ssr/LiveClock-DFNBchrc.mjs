...
//#region node_modules/.nitro/vite/services/ssr/assets/LiveClock-DFNBchrc.js
...
function LiveClock() {
	...
	(0, import_react.useEffect)(() => {
		let isMounted = true;
		if (isMounted) setNow(/* @__PURE__ */ new Date());
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clock, { className: "size-3 sm:size-3.5 text-primary animate-pulse shrink-0" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: [dateStr, /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
