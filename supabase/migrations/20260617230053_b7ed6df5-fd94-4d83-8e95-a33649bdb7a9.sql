...
BEGIN
  ...
  VALUES (NEW.id, CASE WHEN NOT EXISTS (SELECT 1 FROM public.user_roles WHERE role = 'admin') THEN 'admin'::public.app_role ELSE 'member'::public.app_role END)
...
CREATE POLICY "clients_admin_modify" ON public.clients FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "Admins manage meta connections" ON public.meta_connections FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "ad_accounts_admin_modify" ON public.ad_accounts FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "campaigns_admin_modify" ON public.campaigns FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "adsets_admin_modify" ON public.ad_sets FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "ads_admin_modify" ON public.ads FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "insights_admin_modify" ON public.insights_snapshots FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "alerts_admin_modify" ON public.alerts FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "sync_logs_admin_modify" ON public.sync_logs FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
CREATE POLICY "client_campaigns_admin_modify" ON public.client_campaigns FOR ALL TO authenticated USING (public.has_role(auth.uid(), 'admin'::public.app_role)) WITH CHECK (public.has_role(auth.uid(), 'admin'::public.app_role));
...
LANGUAGE sql STABLE SECURITY DEFINER SET search_path = public AS $$
  SELECT mc.id, mc.label, mc.fb_app_id, mc.fb_business_id,
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.insights_snapshots;
